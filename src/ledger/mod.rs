...
use ledger::{general_ledger::GeneralLedger, transaction::assessment::Assessment,
             transaction::payment::Payment, transaction::void_assessment::VoidAssessment,
...
impl<'a> Ledger<'a> {
    pub fn new(
        ...
        void_assessments: Vec<VoidAssessment<'a>>,
